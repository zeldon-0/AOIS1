  ...
  public recommend(): void{
    this.recommendationService
      .recommendArtist(this.recommendationQuery).subscribe(
        artist => {
          if (artist == undefined){
            this.artistResult = new ArtistResult();
            this.artistResult.imageURL = this.notFoundImageURL;
            this.artistResult.name = this.notFoundMessage;
          }
          else{
